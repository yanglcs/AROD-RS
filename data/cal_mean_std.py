...
filepath = ['../data/hrsc/VOC2007/JPEGImages']  # '../data/VOCdevkit/VOC2007/JPEGImages''../datas/VOCdevkit/VOC2007/JPEGImages',,'../datas/VOCdevkit/VOC2012/JPEGImages'../data/hrsc/VOC2007/JPEGImages 数据集目录
img_list = []
for x in filepath:
