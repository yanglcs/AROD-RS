...
class hrscAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = dict(zip(['ship'], [0]))
...
class hrscDetection(data.Dataset):
    ...
    def __init__(self, root,
                 ...
                 transform=None, target_transform=hrscAnnotationTransform(),
                 dataset_name='hrsc', give_size=False,
