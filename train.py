...
parser.add_argument('--dataset', default='VOC', choices=['VOC', 'COCO','hrsc'],
                    type=str, help='VOC, COCO or hrsc')
...
def train():
    if args.dataset == 'COCO':
        ...
        cfg = hrsc
        image_sets=process_names_hrsc(args.data_use, type='trainval')[0]
        logger.info(f'training datasets {image_sets}')
    ...
    for iteration in range(args.start_iter, args.max_iter): #,cfg['max_iter']
